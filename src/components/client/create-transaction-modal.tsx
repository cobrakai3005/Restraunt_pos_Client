            ...
            <div className="space-y-6">
              {type === "JOURNAL" ? (
                <>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-5">
                      ...
                      <div className="space-y-2"><Label>Amount <span className="text-red-500">*</span></Label><Input type="number" min="0" placeholder="e.g. 1000" value={formData.amount === 0 || !formData.amount ? "" : formData.amount} onChange={(e) => setFormData({ ...formData, amount: e.target.value === "" ? 0 : Number(e.target.value) })} className="bg-white" /></div>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2"><Label>Amount <span className="text-red-500">*</span></Label><Input type="number" min="0" placeholder="Enter amount" value={formData.amount === 0 || !formData.amount ? "" : formData.amount} onChange={(e) => setFormData({ ...formData, amount: e.target.value === "" ? 0 : Number(e.target.value) })} className="bg-white" /></div>
