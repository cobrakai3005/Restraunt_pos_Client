...
export function EditRestaurantDialog({ open, onOpenChange, restaurant, onSuccess }: EditRestaurantDialogProps) {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    try {
      ...
      await clientService.updateRestaurant(restaurant._id, values);
