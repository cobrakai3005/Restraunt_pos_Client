...
import { Trash2, Plus, Minus, ShoppingBag, Search, Store, Loader2, UserX, UtensilsCrossed } from "lucide-react";
    ...
    try {
      ...
      if (existingBilledOrder) {
        ...
        return toast({
          ...
          description: `Table ${tabObj?.tableNumber || ""} (Order #${existingBilledOrder._id.slice(-4)}) has an unpaid bill. Please ask Cashier to settle payment or switch to Takeaway.`,
          duration: 7000,
        });
      }
